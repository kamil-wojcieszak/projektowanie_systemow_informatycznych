...
[Wydajność i skalowalność], [], [- utrzymanie czasu odpowiedzi API na poziomie średnio 300ms (95 percentyl)
- wsparcie dla co najmniej 1 000 równoczesnych użytkowników bez spadku wydajności],
[Bezpieczeństwo], [], [- zapewnienie szyfrowania wszystkich haseł użytkowników, 
...
[Dostępność], [], [- zapewnienie drugiej klasy dostępności (dostępność usługi przez co najmniej 99% czasu)],
  [RODO], [], [- mechanizm umożliwiający pobranie danych osobowych (JSON/CSV),
